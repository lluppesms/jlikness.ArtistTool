...
public class AzureOpenAIClientProvider : IAIClientProvider
{
    ...
    public AzureOpenAIClientProvider(string endpoint, string conversationalDeployment = "gpt-4o", string visionDeployment = "gpt-4o",string imageDeployment = "gpt-image-1",ILoggerFactory? loggerFactory = null)
    {
    ...
    private static IChatClient BuildEnhancedChatClient(IChatClient innerClient, string clientName, ILoggerFactory? loggerFactory)
    {
